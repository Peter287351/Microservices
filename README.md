...
- [ ] **module-00-项目脚手架** —— Maven 父工程、common 公共模块、两个单体服务、MySQL 容器、GitHub 建仓
- [ ] **module-01-nacos-注册中心** —— 服务注册与发现，服务列表可视化
- [ ] **module-02-nacos-config-配置中心** —— 配置托管与动态刷新
...
4. **批改**：导师批改、给后续学习建议
5. **提交**：git 提交 + 推送 GitHub，本模块结课，进入下一站
