...
> 📚 **核心文档导航**
> - [docs/微服务开发实战手册.md](docs/微服务开发实战手册.md) —— ⭐ 全组件接入三件套 + 一次下单穿越全部组件的代码之旅（整合手册，新人和复习首选）
> - [docs/快问快答与踩坑速查卡.md](docs/快问快答与踩坑速查卡.md) —— ⚡ 33 问速答 + 踩坑一行速查（面试前 10 分钟扫这页）
> - [docs/错误知识库.md](docs/错误知识库.md) —— 20+ 条五段式真实踩坑复盘
> - [docs/考题与答案汇编.md](docs/考题与答案汇编.md) —— 每模块 3 题参考答案（面试复习）
> - [docs/知识点回顾与复习实操.md](docs/知识点回顾与复习实操.md) —— 每模块复习步骤 + 全链路从零复现清单
> - [docs/数据库设计说明.md](docs/数据库设计说明.md) —— 建表语句与设计取舍
...
- [x] **module-10-security-jwt-安全认证** —— 授权服务器 + 网关统一鉴权
